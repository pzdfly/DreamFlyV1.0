...
public class webtList extends Activity{
	
	private String workidString;
	private ListView listView;
	private Context context=webtList.this;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        getList getlist=new getList(workidString);
        System.out.println(workidString);
        getlist.execute();
        
        
	}
	
	 public class getList extends AsyncTask<String, Void, List<fixList>>{

		private String jsonString;
	    private String workid;
	    
	    public getList(String workidString){
	    	workid=workidString;
	    }
		...
		protected List<fixList> doInBackground(String... params) {
			...
			String url=new String("http://www.peizheng.cn/mobile/index.php?interfaceid=0211&page=1&limit=100&type=web&workid="+workid+"&cname=dfly&cpwd=123456");
		...
		protected void onPostExecute(List<fixList> result) {
			...
			SimpleAdapter listItemAdapter=new SimpleAdapter(webtList.this, listItem, R.layout.baoxiudan_list_item,
			...
			listView.setOnItemClickListener(new OnItemClickListener() {
				public void onItemClick(AdapterView<?> arg0, View arg1,
					...
					intent.setClass(webtList.this, acceptList.class);
