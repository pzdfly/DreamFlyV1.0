...
public class teleList extends Activity{
	
	private String workidString;
	private ListView listView;
	private Context context=teleList.this;
	...
	public void onCreate(Bundle savedInstanceState) {
	 ...
	 public class getMylist extends AsyncTask<String, Void, List<fixList>>{
		...
		protected List<fixList> doInBackground(String... params) {
			...
			String url=new String("http://www.peizheng.cn/mobile/index.php?interfaceid=0211&page=1&limit=100&type=tele&workid="+workid+"&cname=dfly&cpwd=123456");
		...
		protected void onPostExecute(List<fixList> result) {
			...
			SimpleAdapter listItemAdapter=new SimpleAdapter(teleList.this, listItem, R.layout.baoxiudan_list_item,
			...
			listView.setOnItemClickListener(new OnItemClickListener() {
				public void onItemClick(AdapterView<?> arg0, View arg1,
					...
					intent.setClass(teleList.this, listinfo_pcer.class);
